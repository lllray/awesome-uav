...
4. [lis-epfl/vswarm](https://github.com/lis-epfl/vswarm) +2⭐ — vswarm: A ROS package to simulate and deploy vision-based drone swarms
5. [aau-cns/Ardupilot_Multiagent_Simulation](https://github.com/aau-cns/Ardupilot_Multiagent_Simulation) +2⭐ — Simulation environment for multiagent drone systems using Ardupilot, ROS 2, and 
